    ...
    public function run(): void
    {
        $posts = [
            [
                ...
                'category' => 'Tarot',
                'image' => 'img/tarot.jpg',
                'excerpt' => 'Descubre los secretos básicos para empezar a leer el tarot y conectar con tu intuición.',
            ],
            [
                ...
                'excerpt' => 'Aprende sobre las propiedades curativas de los cristales más populares y cómo utilizarlos.',
            ],
            [
                ...
                'excerpt' => 'Comprende los elementos básicos de una carta astral y su significado en tu vida.',
            ],
        ];
